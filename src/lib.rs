...
//! ## Notes
//!
//! This kdtree implementation uses a trait interface, useful for things like ECS and game engines. Agents need to implement KdtreePointTrait to be used in the kdtree.
//!
//! ## Performance
//!
//! The sliding midpoint method is extremely fast. Using (nanoflann)[https://github.com/jlblancoc/nanoflann] as the baseline, Kdtree-rust comes in as the fastest for both constructing trees, and querying them. On a 2.9 GHz i7, we get 19ms to construct a 100k node tree and 318.74ns to query it.
//!
//! It should be noted that kdtrees are meant for a construct-once and query-often access patterns. This might library might be fast enough for your use case, but real-time nearest-neighbors is still a hard problem to solve.
//!
//!
